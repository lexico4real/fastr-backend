  ...
  async getStudentSummary() {
    try {
      ...
      this.logger.log(
        'AnalyticsService',
        'info',
        'Successfully fetched student summary',
        'analytics',
      );
      ...
      this.logger.log(
        'AnalyticsService',
        'error',
        `Error fetching student summary: ${error}`,
        'analytics',
      );
  ...
  async getBusinessSummary() {
    try {
      ...
      this.logger.log(
        'AnalyticsService',
        'info',
        'Successfully fetched business summary',
        'analytics',
      );
      ...
      this.logger.log(
        'AnalyticsService',
        'error',
        `Error fetching business summary: ${error}`,
        'analytics',
      );
  ...
  async getAdminSummary() {
    try {
      ...
      this.logger.log(
        'AnalyticsService',
        'info',
        'Successfully fetched admin summary',
        'analytics',
      );
      ...
      this.logger.log(
        'AnalyticsService',
        'error',
        `Error fetching admin summary: ${error}`,
        'analytics',
      );
